...
export const About: React.FC = () => {
    return (
        <div id='about' className='mt-32 md:mt-40 mb-3 px-14 text-[#7e7e6b] dark:text-amber-50 flex flex-col md:flex-row md:justify-between items-center gap-5 md:gap-0'>
